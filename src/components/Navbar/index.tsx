...
export const Navbar: React.FC = () => {
   ...
   const baseStyle = 'inline-block flex items-center mx-1 px-3 py-2 text-white font-light text-md leading-tight rounded-md hover:bg-red-400 transition ease-in-out delay-150'
